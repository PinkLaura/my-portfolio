...
export default function LeasyBanner() {
    return (
        ...
        <section className="container max-w-6xl	px-6 my-10" >
            <div className=" bg-white rounded-3xl p-6 flex md:flex-row flex-col gap-3 drop-shadow-1 relative z-20">
                <div className="flex flex-col gap-1 md:w-[40%] px-3 py-6">
                ...
                <div className="flex md:flex-row flex-col gap-3 w-full text-center">
                    <div className="flex flex-row gap-3 md:w-2/5 w-full">
                        {/* box 1 */}
                        <Link href="./chapter-1"
                ...
                border-indigo-500 text-indigo-500 stroke-indigo-500 hover:border-indigo-600 hover:text-indigo-600 hover:stroke-indigo-600">
                    ...
                    <div className="flex flex-row gap-3 md:w-1/5 w-full">
                        {/* box 5 */}
                        <Link href="./chapter-5"
                            className="group rounded-2xl border border-dashed w-full
                        p-3 flex flex-col gap-3 justify-center items-center font-medium font-serif
