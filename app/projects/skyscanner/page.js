...
export default function skyscannerProject() {
    return (
        <>
            ...
            <NextProject
                image={"https://pinklaura.github.io/my-portfolio/img/projects/retake-cover.png"}
                src={"./retake"}
                title={"Retake"}
                text={
                    <>
                        ...
                        <p>
                            Bending Spoons developed an exciting new technology that uses AI to generate realistic photos of users in diverse contexts, starting from just a few selfies, and I had to design an app that can maximise the value of this new technology.
                        </p>
