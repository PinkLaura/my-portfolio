...
export default function retakeProject() {
    return (
        ...
        <>
            ...
            <NextProject
                image={"https://pinklaura.github.io/my-portfolio/img/projects/leasy-cover.png"}
                src={"./leasy-project/chapter-5"}
                title={"Leasy - Property Manager Dashboard"}
                text={
                    <>
                        <p className="mb-2">
                            Leasy is a financial and administrative platform targeting specifically property managers and landlords with a lot of property. It allows to track payments and automatically remind tenants to pay.                        </p>
                        <p>
                            I worked on Leasy for one year and developed a lot of exciting features.
                        </p>
